...
window.cetamAlert = {
  ...
  confirmDelete: function confirmDelete() {
    var title = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '¿Eliminar registro?';
    var text = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'Esta acción no se puede deshacer';
    return Swal.fire({
      title: title,
      text: text,
      icon: 'warning',
