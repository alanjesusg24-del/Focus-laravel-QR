...
<div class="theme-settings card bg-gray-800 pt-2 collapse" id="theme-settings">
    <div class="card-body bg-gray-800 text-white pt-4">
        ...
        <div class="mb-3">
            <h6 class="text-white mb-2">Order QR System</h6>
            <p class="fs-7 text-gray-300 mb-2">
                Sistema de gestión de órdenes con códigos QR para negocios.
            </p>
            <p class="fs-7 text-gray-400 mb-0">Versión 1.0.1</p>
        </div>
    </div>
</div>
