...
<div class="py-4">
    ...
    <div class="d-flex justify-content-between w-100 flex-wrap">
        ...
        <div>
            <a href="{{ route('superadmin.profile.index') }}" class="btn btn-secondary d-inline-flex align-items-center">
...
<div class="row">
        ...
        <div class="card border-0 shadow">
            ...
            <div class="card-body">
                <form action="{{ route('superadmin.profile.update') }}" method="POST">
                    ...
                    <h3 class="h5 mb-3">Cambiar Contraseña (Opcional)</h3>
                    ...
                    <div class="mt-4">
                        ...
                        <a href="{{ route('superadmin.profile.index') }}" class="btn btn-secondary">Cancelar</a>
                    </div>
                </form>
            </div>
        </div>
    ...
    <div class="col-12 col-xl-4">
        <div class="card border-0 shadow mb-4">
            <div class="card-body">
                <h5 class="card-title">
                    <svg class="icon icon-xs me-2 text-info" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd"></path>
                    </svg>
                    Recomendaciones
                </h5>
                <ul class="list-unstyled small text-gray-700">
                    <li class="mb-2">
