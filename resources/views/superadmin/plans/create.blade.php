        ...
        <div class="col-12 col-lg-10 col-xl-8">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <input type="number" class="form-control @error('retention_days') is-invalid @enderror" id="retention_days" name="retention_days" value="{{ old('retention_days', 90) }}" min="0">
            ...
            <div class="card border-0 shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <div id="realert-fields" style="display: {{ old('has_realerts') ? 'block' : 'none' }};">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-3">
                                ...
                                <input type="number" class="form-control form-control-sm" id="realert_days" name="realert_days" value="{{ old('realert_days', 0) }}" min="0" max="30" onchange="updateIntervalMinutes()">
                            </div>
                            <div class="col-md-3">
                                <label for="realert_hours" class="form-label small">Horas</label>
                                <input type="number" class="form-control form-control-sm" id="realert_hours" name="realert_hours" value="{{ old('realert_hours', 0) }}" min="0" max="23" onchange="updateIntervalMinutes()">
                            </div>
                            <div class="col-md-3">
                                <label for="realert_minutes" class="form-label small">Minutos</label>
                                <input type="number" class="form-control form-control-sm" id="realert_minutes" name="realert_minutes" value="{{ old('realert_minutes', 15) }}" min="1" max="59" onchange="updateIntervalMinutes()">
                            </div>
                            <div class="col-md-3">
                                <label for="realert_max_count" class="form-label small">Máximo alertas</label>
                                <input type="number" class="form-control form-control-sm" id="realert_max_count" name="realert_max_count" value="{{ old('realert_max_count', 4) }}" min="1" max="20">
                            </div>
                        </div>
