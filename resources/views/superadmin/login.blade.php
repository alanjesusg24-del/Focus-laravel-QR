...
<style>
    :root {
        ...
        --superadmin-gray: #495057;
    }
    .bg-superadmin-dark { background-color: var(--superadmin-dark) !important; }
    .text-superadmin-dark { color: var(--superadmin-dark) !important; }
    .btn-superadmin-dark {
        background-color: var(--superadmin-dark) !important;
        border-color: var(--superadmin-dark) !important;
    ...
    .text-superadmin-red { color: var(--superadmin-red) !important; }
    .form-bg-image {
                        ...
                        <div class="signin-inner my-3 my-lg-0 bg-white shadow-soft border rounded border-gray-300 p-4 p-lg-5 w-100 fmxw-500">
                            ...
                            <div class="text-center text-md-center mb-4 mt-md-0">
                                <div class="d-flex justify-content-center mb-3">
                                    <div class="bg-superadmin-dark rounded-circle d-flex align-items-center justify-center" style="width: 64px; height: 64px;">
                                ...
                                <h1 class="mb-0 h3 text-superadmin-dark">Super Administrador</h1>
                            ...
                            <form method="POST" action="{{ route('superadmin.login') }}" class="mt-4">
                                ...
                                <!-- Submit Button -->
                                <div class="d-grid">
                                    <button type="submit" class="btn btn-superadmin-dark">Iniciar Sesión</button>
                                </div>
                            </form>
