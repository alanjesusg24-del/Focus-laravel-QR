                                            ...
                                            <label class="plan-card card h-100 mb-0" onclick="selectPlan({{ $plan->plan_id }})">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <ul class="list-unstyled small">
                                                        <li class="mb-2">
                                                            <x-icon name="{{ $plan->has_chat_module ? 'checkCircle' : 'timesCircle' }}" class="{{ $plan->has_chat_module ? 'text-success' : 'text-muted' }} me-1" />
                                                            Modulo de chat
                                                        ...
                                                        <li class="mb-2">
                                                            <x-icon name="checkCircle" class="text-success me-1" />
